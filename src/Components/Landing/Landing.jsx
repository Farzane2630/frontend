        ...
        <section className="landing">
            <div className="container">
                    ...
                    <Typewriter
                        onInit={typewriter => {
                            typewriter.typeString('ما به هر قیمتی دوره آموزشی تولید نمی کنیم !')
                                ...
                                .pauseFor(3000)
                                .deleteAll()
                                .typeString('با آکادمی سبزلرن، برنامه نویسی رو با خیال راحت یاد بگیر و پیشرفت کن.')
                                .start()
                                .pauseFor(3000)
                                .deleteAll()
                        }}
                ...
                <h2 className="landing__subtitle">
                    آکادمی خصوصی برنامه نویسی سبزلرن
                </h2>
                <div className="landing__searchbar">
                    <input onChange={e => setSearchValue(e.target.value)} type="text" className="landing__searchbar-input" placeholder="چه چیزی دوست داری یاد بگیری ..." />
                    <button className="landing__searchbar-btn" type="submit" onClick={e => showResult(e)}>
